...
int main(){
    ...
    if(test.addSong("Muslum Gurses", "Nilufer", "Emre Sevilgen", 3, 50))
        cout << "successful addition" << endl;
    else
        cout << "unsuccessful addition" << endl;
    displayAllMusicAlbums(test);
    displayStatistics(test);
    test.addMusicAlbum("Muslum Gurses", "Nilufer", 2018);
    if(test.addSong("Muslum Gurses", "Nilufer", "Emre Sevilgen", 3, 50))
    ...
    displayAllMusicAlbums(test);
    displayStatistics(test);
    if(test.addSong("Muslum Gurses", "Nilufer", "Munib Emre Sevilgen", 0, 10))
        cout << "successful addition" << endl;
    else
        cout << "unsuccessful addition" << endl;
    displayAllMusicAlbums(test);
    displayStatistics(test);
    if(test.addSong("Zeki Muren", "Ah bu sarkilarin gozu kor olsun", "Emre Sevilgen", 1, 0))
        cout << "successful addition" << endl;
    else
        cout << "unsuccessful addition" << endl;
    displayAllMusicAlbums(test);
